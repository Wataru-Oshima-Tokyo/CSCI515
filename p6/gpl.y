...
termination_block:
    T_TERMINATION statement_block{
        Event_manager::instance().add_handler(Window::TERMINATE, $2);
    }
...
unary_expr
    ...
    | primary_expression T_TOUCHES primary_expression {$$ = bin_op_check<Touches, GPL::TOUCHES>($1, $3, GPL::GAME_OBJECT); }
    | primary_expression T_NEAR primary_expression {$$ = bin_op_check<Near, GPL::NEAR>($1, $3, GPL::GAME_OBJECT); }
    ;
