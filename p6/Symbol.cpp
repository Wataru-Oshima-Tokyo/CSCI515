...
std::ostream& operator<<(std::ostream& os, const Symbol& sym) {
    switch (sym.get_type()) {
        ...
        case GPL::Type::TEXTBOX: 
         ...
         break;
        case GPL::Type::ANIMATION_CODE: 
            //To-do list nned to implement to show the name
            os << "animation code " << sym.get_name();
            // os << "animation code" << *sym.value_.animation_code_pointer;
         break;
...
const Constant* Symbol::as_constant() const {
    switch (type_) {
        ...
        case GPL::RECTANGLE:
            return new Game_object_constant(value_.rectangle_pointer);
        case GPL::CIRCLE:
            return new Game_object_constant(value_.circle_pointer);
        case GPL::TEXTBOX:
            return new Game_object_constant(value_.textbox_pointer);
        case GPL::PIXMAP:
...
const Constant* Symbol::as_constant(int index) const {
    ...
    switch (type_) {
        ...
        case GPL::RECTANGLE:
            return new Game_object_constant(&value_.rectangle_pointer[index]);
        case GPL::CIRCLE:
            return new Game_object_constant(&value_.circle_pointer[index]);
        case GPL::TEXTBOX:
            return new Game_object_constant(&value_.textbox_pointer[index]);
        case GPL::PIXMAP:
            return new Game_object_constant(&value_.pixmap_pointer[index]);
        case GPL::TRIANGLE:
            return new Game_object_constant(&value_.triangle_pointer[index]);
        default:
            throw type_;
    }
}
